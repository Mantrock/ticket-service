...
import emmert.frank.repositories.CustomerRepository;
...
public class ticketServiceCodingChallengeApplication {
    ...
    private static final Logger log = LoggerFactory.getLogger(ticketServiceCodingChallengeApplication.class);
